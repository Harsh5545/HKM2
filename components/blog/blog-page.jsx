      ...
      <div className="container max-w-[1200px] mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-col lg:flex-row-reverse gap-10">
          ...
          >
            ...
            {/* Author Bio Card */}
            <div className="bg-primary/5 dark:bg-primary/10 rounded-xl p-6 flex flex-col sm:flex-row gap-6 items-center">
              <Avatar className="h-24 w-24 border-4 border-white dark:border-gray-800 shadow-md">
                <AvatarImage
                  src={data.author?.image || "/assets/Manasi_kadam_image.jpg"}
                  alt={data.author ? `${data.author.first_name} ${data.author.last_name}` : "Manasi Kadam"}
                />
          ...
          >
            ...
            {data.recentBlogs && data.recentBlogs.length > 0 && (
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 sticky top-24">
