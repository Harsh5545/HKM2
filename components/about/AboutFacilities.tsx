      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Our <span className="text-[#113F6C] dark:text-[#e9414d]">Facilities</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <Monitor className="h-10 w-10 text-[#113F6C] dark:text-[#e9414d] mb-4" />
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <Cpu className="h-10 w-10 text-[#113F6C] dark:text-[#e9414d] mb-4" />
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <Headphones className="h-10 w-10 text-[#113F6C] dark:text-[#e9414d] mb-4" />
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <Coffee className="h-10 w-10 text-[#113F6C] dark:text-[#e9414d] mb-4" />
